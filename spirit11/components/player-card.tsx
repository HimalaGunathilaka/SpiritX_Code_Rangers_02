...
export default function PlayerCard({ player }: { player: PlayerInfo }) {
  ...
  const batAverage =
    player.inningsplayed > 0
      ...
      : 0;
  const bowlStrikeRate =
    player.wickets > 0
      ? ((player.overbowled * 6) / player.wickets).toFixed(2)
      : 0;
  const economy =
    player.overbowled > 0
      ? (player.runsconceded / player.overbowled).toFixed(2)
      : 0;
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              <div className="flex items-center">
                ...
                <span
                  className={`ml-2 px-2 py-0.5 text-xs rounded-full ${getRoleColor(
                    player.category
                  )}`}
                >
                  {player.category.charAt(0).toUpperCase() +
                    player.category.slice(1)}
                </span>
              </div>
          ...
          <div className="flex items-center mt-4 md:mt-0">
            <div className="grid grid-cols-3 gap-3 mr-4">
              <div className="text-center">
                ...
                <p className="font-medium text-gray-900">{player.totalruns}</p>
              </div>
              <div className="text-center">
              ...
              <div className="text-center">
                ...
                <p className="font-medium text-gray-900">{player.wickets}</p>
              </div>
            </div>
            <button
          ...
          <div className="mt-4 pt-4 border-t">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="p-3 bg-gray-50 rounded-md">
                ...
                <p className="font-medium text-lg text-gray-900">{economy}</p>
              </div>
            </div>
            <div className="mt-4 flex justify-between">
              ...
              <div className="text-sm text-gray-500">
                ...
                <span
                  className={
                    player.available ? "text-green-600" : "text-red-600"
                  }
                >
