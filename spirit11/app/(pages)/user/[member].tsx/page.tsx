  ...
  return (
    <div className="flex justify-between items-center p-3 bg-gray-50 rounded-md">
      ...
      <div className="flex items-center">
        ...
        {isPositive ? (
          // Arrow Up Right Icon
          <svg xmlns="http://www.w3.org/2000/svg" className="ml-1 h-4 w-4 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 11l5-5m0 0l5 5m-5-5v12" />
          </svg>
        ) : (
          // Arrow Down Right Icon
          <svg xmlns="http://www.w3.org/2000/svg" className="ml-1 h-4 w-4 text-red-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
