...
export default function PlayerSearch() {
  ...
  const filteredPlayers = players.filter((player) => {
    ...
    const matchesUniversity = filterUniversity
      ? player.university === filterUniversity
      : true;
        ...
        <div className="container mx-auto">
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-4">
              ...
              <h1 className="text-xl font-bold text-gray-900">Player Directory</h1>
            </div>
          </div>
        </div>
      </header>
          ...
          <div className="flex flex-col md:flex-row gap-4 mb-6">
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent text-gray-900"
              />
            </div>
          </div>
